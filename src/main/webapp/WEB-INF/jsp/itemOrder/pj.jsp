        ...
        <div id="vipRight">
            ...
            <div class="bj_fff hidden_yh" style="width:838px;border:1px solid #ddd;margin-top:29px;padding:50px;">
                <div class="width100" style="height:32px;line-height:32px;">
                	<div class="left_yh font16 tright" style="width:120px;"><font class="red">*</font>评价内容：</div>
                    <input type="text" id="jiu" name="content"  style="width:303px;border:1px solid #ddd;outline:none;height:100px;text-indent:10px;">
                </div>

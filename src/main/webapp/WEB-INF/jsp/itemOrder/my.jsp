        ...
        <div id="vipRight">
            <div style="width:938px;border:1px solid #ddd;background:#fff;">
            	...
            	<div class="width100 hidden_yh" style="height:74px;line-height:74px;background:#f5f8fa;border-bottom:1px solid #ddd;" id="navLt">
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange slect">全部订单(${fn:length(all)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">已取消(${fn:length(yqx)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">待发货(${fn:length(dfh)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">待收货(${fn:length(yfh)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">已收货(${fn:length(ysh)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">已评价(${fn:length(ypj)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">退货中(${fn:length(dth)})</span>
                    <span class="left_yh font18 width14 tcenter cursor onHover onorange">已退货(${fn:length(yth)})</span>
                </div>
                <!--全部订单-->
                   ...
                   <c:forEach items="${all}" var="data" varStatus="l">
                	...
                	<div class="width100 hidden_yh font20 c_66" style="background:#faf5f5;text-indent:47px;height:50px;line-height:50px;border-bottom:1px solid #ddd;">
                     ...
                     <!--  0.新建代发货1.已取消 2已已发货3.到收货 -->
                      ...
                      <c:if test="${data.status == 5}"> 退货中</c:if>
                      <c:if test="${data.status == 6}"> 已退货</c:if>
                    ...
                    <!--之一 details -->
                     ...
                     <c:forEach items="${data.details}" var="chil" varStatus="l">
	                      <div style="width:838px;border-bottom:1px dashed #ddd;padding-top:30px;padding-bottom:30px;" class="hidden_yh center_yh">
	                        ...
	                        <div class="right_yh">
                            <a href="${ctx}/item/view?id=${chil.itemId}" class="c_33 onHover font20 onorange right_yh" style="margin-top:">商品详情</a>
	                         <c:if test="${data.status == 3}"> 
	                            <a href="${ctx}/itemOrder/pj?id=${chil.itemId}&orderId=${data.id}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top:10px;padding:6px;">去评价</a>
	                        </c:if>
	                        </div>
	                     </div>
                     </c:forEach>
                    ...
                    <div style="width:838px;padding-top:30px;padding-bottom:30px;" class="hidden_yh center_yh tleft">
                    	<font class="font24">总金额<font class="font18 c_66">(含运费0元)：</font></font><font class="red font34"><font class="font24">￥</font>${data.total}</font>
	                      ...
	                      <c:if test="${data.status == 2}"> 
	                         <a href="${ctx}/itemOrder/th?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top:">去退货&nbsp;&nbsp;</a>
                      		 <a href="${ctx}/itemOrder/sh?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top:">确认收货&nbsp;&nbsp;</a>
	                     </c:if>
                         <c:if test="${data.status == 3}"> 
	                            <a href="#" class="c_33 onHover font20 onorange right_yh" style="margin-top:">已收货</a>
	                     </c:if>
                         <c:if test="${data.status == 4}"> 
	                            <a href="#" class="c_33 onHover font20 onorange right_yh" style="margin-top:">已评价</a>
	                     </c:if>
                         <c:if test="${data.status == 5}"> 
	                            <a href="#" class="c_33 onHover font20 onorange right_yh" style="margin-top:">退货中</a>
	                     </c:if>
                         <c:if test="${data.status == 6}"> 
	                            <a href="${ctx}/itemOrder/thDetail?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top:">已退货</a>
	                     </c:if>
                    </div>
                	</div>
                	<!-- 这是一个整的   end-->
                ...
                <div class="assess width100 hidden_yh hhD" style="display:none;">
                    ...
                    <!--之一 details -->
                     ...
                     <c:forEach items="${data.details}" var="chil" varStatus="l">
	                      <div style="width:838px;border-bottom:1px dashed #ddd;padding-top:30px;padding-bottom:30px;" class="hidden_yh center_yh">
	                        ...
	                        <c:if test="${data.status == 3}"> 
	                            <a href="${ctx}/itemOrder/pj?id=${chil.itemId}&orderId=${data.id}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top:10px;padding:6px;">去评价</a>
	                        <a href="${ctx}/item/view?id=${chil.itemId}" class="c_33 onHover font18 onorange right_yh" style="margin-top:10px">商品详情</a>
	                        </c:if>
                 ...
                 <!--已评价-->
                <div class="assess width100 hidden_yh hhD" style="display:none;">
                	 <c:forEach items="${ypj}" var="data" varStatus="l">
                	<!--bottom(一条)-->
                	<div class="width100 hidden_yh">
                    <!--标题-->
                	<div class="width100 hidden_yh font20 c_66" style="background:#faf5f5;text-indent:47px;height:50px;line-height:50px;border-bottom:1px solid #ddd;">
                     ...
                     <c:forEach items="${data.details}" var="chil" varStatus="l">
	                      <div style="width:838px;border-bottom:1px dashed #ddd;padding-top:30px;padding-bottom:30px;" class="hidden_yh center_yh">
	                        ...
	                        <div class="left_yh" style="width:580px;">
	                          ...
	                          <div class="right_yh">
	                          <c:if test="${data.status == 4}"> 
	                       		<a href="${ctx}/itemOrder/pj?id=${chil.itemId}&orderId=${data.id}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top:10px;padding:6px;">追加评价</a>
	                            <a href="${ctx}/item/view?id=${chil.itemId}&orderId=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top:10px">商品详情</a>
                     		</c:if>
                  ...
                  <!--退货待确认-->
                <div class="assess width100 hidden_yh hhD" style="display:none;">
                	 <c:forEach items="${dth}" var="data" varStatus="l">
                	<!--bottom(一条)-->
                	<div class="width100 hidden_yh">
                    <!--标题-->
                	<div class="width100 hidden_yh font20 c_66" style="background:#faf5f5;text-indent:47px;height:50px;line-height:50px;border-bottom:1px solid #ddd;">
                    ...
                    <!--总结-->
                    <div style="width:838px;padding-top:30px;padding-bottom:30px;" class="hidden_yh center_yh tleft">
                    	<font class="font24">总金额<font class="font18 c_66">(含运费0元)：</font></font>
                    	<font class="red font34"><font class="font24">￥</font>${data.total}</font>
	                       <c:if test="${data.status == 5}"> 
	                            <a href="${ctx}/itemOrder/thDetail?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top:">退货中</a>
	                     </c:if>
	                    <%--   --%>
                    </div>
                	</div>
                  ...
                  <!--退货确认-->
                <div class="assess width100 hidden_yh hhD" style="display:none;">
                	 <c:forEach items="${yth}" var="data" varStatus="l">
                	<!--bottom(一条)-->
                	<div class="width100 hidden_yh">
                    <!--标题-->
                	<div class="width100 hidden_yh font20 c_66" style="background:#faf5f5;text-indent:47px;height:50px;line-height:50px;border-bottom:1px solid #ddd;">

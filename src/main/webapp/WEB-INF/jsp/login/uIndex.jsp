...
<div class="width1200 center_yh hidden_yh" style="position:relative;z-index:80;">
    <div class="example2" style="width:1200px;height:490px;overflow:hidden;margin-left:234px">
        <ul>
            <li><img style="width: 966px; height: 490px;" src="${ctx}/resource/images/swiper2.jpg" alt="1"/></li>
            <li><img style="width: 966px; height: 490px;" src="${ctx}/resource/images/swiper1.jpg" alt="1"/></li>
        </ul>
    </div>
    <!--Luara图片切换骨架end-->
    <script>
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
        ...
        <a href="${pageContext.servletContext.contextPath}/item/shoplist_zk" class="right_yh c_33 font16">更多»</a>
    </div>
        ...
        <div class="normalPic">
             <c:forEach items="${zks}" var="data" varStatus="l">
	             <a href="${ctx}/item/view?id=${data.id}">
	            	<div class="yihang c_33 font14 font100" style="text-align:center;padding-right:10px;margin-top:10px;margin-bottom:10px;">${data.name}</div>
	                <img src="${data.url1}" width="105" height="118" style="margin:0 auto">
	                <div class="red font14" style="text-align: center;margin-top:10px;">￥${data.price}</div>
	            </a>
             </c:forEach>
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
        ...
        <a href="${pageContext.servletContext.contextPath}/item/shoplist_rx" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:480px;">
        <div class="normalPic">
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
    	<font class="left_yh font20">猜你喜欢</font>
        <a href="${pageContext.servletContext.contextPath}/item/shoplist" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:280px">
        <div class="normalPic">
        	 <c:forEach items="${recommendList}" var="data" varStatus="l">
	             <a href="${ctx}/item/view?id=${data.id}">
	            	<div class="yihang c_33 font14 font100" style="text-align:center;padding-right:10px;margin-top:10px;margin-bottom:10px;">${data.name}</div>
	                <img src="${data.url1}" width="105" height="118" style="margin:0 auto">
	                <div class="red font14" style="text-align: center;margin-top:10px;">￥${data.price}</div>

...
<div class="result-wrap">
      <div class="result-content">
          <form action="${ctx}/userPost/homeExAdd" method="post" id="myform" name="myform" enctype="multipart/form-data">
              <table class="insert-tab" width="100%">
                  <tbody>
                  <tr>
                     <th style="width:100px;"><i class="require-red">*</i>帖子主题：</th>
                     <td>
                         <input class="common-text required" style="width:100%;" id="title" name="title" size="50" value="" type="text">
                     </td>
                  </tr>

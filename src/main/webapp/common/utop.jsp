 ...
 <!--头部-->
   <div class="width100" style="height:25ox;background:#f0f0f0;">
	<div class="width1200 center_yh font14 c_66" style="height:25px;line-height:25px;">
    	<font class="left_yh">欢迎来到游戏商城！</font>
...
<div class="width100 hidden_yh" >
	<div class="width1200 center_yh hidden_yh" style="margin-bottom: -0px">
    	<a href="#" class="block_yh left_yh" style="margin-top:10px;"><img src="${ctx}/resource/images/1521544521_514634.png" style="height:70px"></a>

            ...
            <div class="bj_fff hidden_yh" style="width:838px;border:1px solid #ddd;margin-top:29px;padding:50px;">
                <div class="width100" style="height:32px;line-height:32px;">
	               <div class="width100" style="height:32px;line-height:32px;margin:10px 0px;">
                	...
                	<input type="text" id="refundWay" name="refundWay" value="${itemOrder.refundWay}"  style="width:303px;border:1px solid #ddd;outline:none;height:30px;text-indent:10px;">
                </div>
                <div class="width100" style="height:32px;line-height:32px;">
                	<div class="left_yh font16 tright" style="width:120px;"><font class="red">*</font>退货缘由：</div>
                    <input type="text" id="jiu" name="content"  value="${itemOrder.content}" style="width:303px;border:1px solid #ddd;outline:none;height:30px;text-indent:10px;">
                </div>
                <div class="width100" style="height:32px;line-height:32px; margin:10px 0px;">
                	<div class="left_yh font16 tright" style="width:120px;"><font class="red">*</font>退货备注：</div>
                	<textarea rows="" cols="" id="remark" value="${itemOrder.remark}"  name="remark" style="width:303px;border:1px solid #ddd;outline:none;height:100px;">${itemOrder.remark}
                	</textarea>
                	</div>
                 <div class="width100" style="height:32px;line-height:32px;margin-top:83px;">
                	<a href="${ctx}/itemOrder/my"  class="left_yh block_yh font16 tcenter ff5802 con" style="width:244px;height:33px;line-height:33px;margin-left:120px;">返回</a>
                </div>
            </div>
            </form>
    	</div>
